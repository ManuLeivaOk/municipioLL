...
const Instituciones = () => {
  const tab1HeaderTemplate = (options: TabPanelHeaderTemplateOptions) => {
    return (
      ...
      >
        <Avatar image="/spo.jpg" shape="circle" />
        <span className="font-bold white-space-nowrap">Club Sportivo</span>
      </div>
    );
  };
  ...
  const tab2HeaderTemplate = (options: TabPanelHeaderTemplateOptions) => {
    return (
      <div
        ...
        onClick={options.onClick}
      >
        <Avatar image="/new.png" shape="circle" />
        <span className="font-bold white-space-nowrap">Newel´s</span>
      </div>
    );
  };
